    ...
    constructor() {
        ...
        this.credentials = [
            ...
            },
            {
                ...
                name: 'scope',
                type: 'string',
                default: `["openid", "profile", "email", "accounting.settings", "accounting.reports.read", "accounting.journals.read", "accounting.contacts", "accounting.attachments", "accounting.transactions", "offline_access"]`
            }
        ];
    }
}
