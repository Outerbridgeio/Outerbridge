				...
				options: [
                    {
                        ...
                        description: 'Go to https://labs.openai.com/. Open Network Tab in Developer Tools. Type a promt and press "Generate". Look for fetch to https://labs.openai.com/api/labs/tasks. In the request header look for authorization then get the Bearer Token.'
					},
				],
