...
class DuneAnalytics implements INode {
    // properties
    label: string
    name: string
    type: NodeType
    ...
    constructor() {
        // properties
        this.label = 'Dune Analytics'
        this.name = 'duneAnalytics'
        this.icon = 'dune.png'
        this.type = 'action'
        this.category = 'Block Explorer'
        this.version = 1.0
        this.description = 'Execute Dune Analytics APIs and SQL query'
        this.incoming = 1
        this.outgoing = 1
...
module.exports = { nodeClass: DuneAnalytics }
